...
class HelpCommand extends Command
{
    ...
    public function fire()
    {
        ...
        $help_msg .= "Each night, the werewolves will be allowed to vote privately on one player to eliminate. The decision must be unanimous. If its not, you'll keep voting until it is. The bot will private message you.\r\n";
        ...
        $help_msg .= "|_  !start @user1 @user2 @user3 - Starts a new game with the specified users participating\r\n";
